...
export default function PlayerUpdateForm(props) {
  ...
  const [has_confirmed, setHas_confirmed] = React.useState(
    initialValues.has_confirmed
  );
  ...
  const resetStateValues = () => {
    ...
    setHas_confirmed(cleanValues.has_confirmed);
    setPlays_mondays(cleanValues.plays_mondays);
      ...
      <SwitchField
        ...
        onChange={(e) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            value = result?.has_confirmed ?? value;
          }
          if (errors.has_confirmed?.hasError) {
            runValidationTasks("has_confirmed", value);
          }
          setHas_confirmed(value);
        }}
        onBlur={() => runValidationTasks("has_confirmed", has_confirmed)}
        errorMessage={errors.has_confirmed?.errorMessage}
        hasError={errors.has_confirmed?.hasError}
        {...getOverrideProps(overrides, "has_confirmed")}
      ></SwitchField>
      <SwitchField
        label="Plays mondays"
        defaultChecked={false}
