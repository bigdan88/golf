...
export default function GolfRound9CreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setHole1(initialValues.hole1);
    setHole2(initialValues.hole2);
    setHole3(initialValues.hole3);
    setHole4(initialValues.hole4);
    setHole5(initialValues.hole5);
    setHole6(initialValues.hole6);
    setHole7(initialValues.hole7);
    setHole8(initialValues.hole8);
    setHole9(initialValues.hole9);
    setErrors({});
  };
  const validations = {
    date: [{ type: "Required" }],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new GolfRound9(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "GolfRound9CreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
